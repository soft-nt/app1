...
must_haves:
  truths:
    ...
    - "Current temperature displays in Celsius with degree symbol (e.g., 15C)"
...
- Open browser to localhost, observe:
  ...
  2. Temperature shows with degree symbol (e.g., "15°C")
...
3. **Runtime verification:** `npm run dev` and check:
   ...
   - Weather shows: Geneva label, icon, temperature (e.g., "15°C"), condition text
